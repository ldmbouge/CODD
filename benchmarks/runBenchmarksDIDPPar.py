...
#python3 /home/fabio/didp-models/tsptw/tsptw_didp.py ../data/tsptw/AFG/rbg021.7.tw --config CABS --initial-beam-size 32 --threads 64 --parallel-type 0 --history history.csv --time-out 300


timeout = 10 * 60
exe = "/home/fabio/didp-models/tsptw/tsptw_didp.py"
resultsDir  = "./results"
